...
3. Edit config.yaml file in AWSSQSMonitor/conf and provide the required configuration (see Configuration section)
...
| | displayAccountName | Display name used in metric path | "MyAWSSQS" |
| | regions | Regions where SQS is registered | **Allowed values:**<br/>"ap-southeast-1",<br/>"ap-southeast-2",<br/>"ap-northeast-1",<br/>"eu-central-1",<br/>"eu-west-1",<br/>"us-east-1",<br/>"us-west-1",<br/>"us-west-2",<br/>"sa-east-1" |
...
| | ----- | ----- | ----- |
| | metricPrefix | The path prefix for viewing metrics in the metric browser. | "Custom Metrics\|Amazon SQS\|" |
...
Find out more in the [AppSphere](https://www.appdynamics.com/community/exchange/extension/aws-sqs-monitoring-extension) community.
