 ...
 */
public class SQSMetricsProcessor implements MetricsProcessor {

    private static final String NAMESPACE = "AWS/SQS";

    private static final String[] DIMENSIONS = {"QueueName"};

    private List<MetricType> metricTypes;

    private Pattern excludeMetricsPattern;

    public SQSMetricsProcessor(List<MetricType> metricTypes,
    ...
    public Map<String, Double> createMetricStatsMapForUpload(NamespaceMetricStatistics namespaceMetricStats) {
        ...
        dimensionToMetricPathNameDictionary.put(DIMENSIONS[0], "Queue Name");
